...
public class Guerrero extends Personajes{
    ...
    public Guerrero(String nombre, int salud, int nivel, int coordenadaX, int coordenadaY, boolean vivo, int exp, int fuerza, int agilidad, int mana, int dinero, ArrayList<Equipamiento> equipamiento) {
    ...
    public void atacar(ArrayList <Criaturas> criaturas, ArrayList<Personajes> personajes, int personaje_atacante, Mapa mapa) {
        ...
        System.out.println("2.- Habilidad Especial || fuerza " + personajes.get(personaje_atacante).getFuerza() + " por danio extra aletorio entre 1 y 5");
        ...
        if (ataque == 1 || ataque == 2 || ataque == 3) {
            ...
            if (objetivo.setVivo()) {
                ...
                personajes.get(personaje_atacante).setExp(objetivo.getExp(), personajes.get(personaje_atacante));
    ...
    public void usarHabilidades(Criaturas objetivo, ArrayList<Criaturas> criaturas) {
        ...
        int multiplicador = (ataque.nextInt(4) + 1); // Valor entre 1 y 4
        int dano = this.fuerza * multiplicador;
        System.out.println("\n" + this.nombre + " ataca a " + objetivo.getNombre() + " causando " + dano + " de daño.");
