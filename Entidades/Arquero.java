...
public class Arquero extends Personajes{
    ...
    public Arquero(String nombre, int salud, int nivel, int coordenadaX, int coordenadaY, boolean vivo, int exp, int fuerza, int agilidad, int mana, int dinero, List<Equipamiento> equipamiento) {
    ...
    public void atacar(ArrayList <Criaturas> criaturas, ArrayList<Personajes> personajes, int personaje_atacante, Mapa mapa) {
        ...
        System.out.println("2.- Habilidad Especial || Lluvia de flechas");
    ...
    public void usarHabilidades(Criaturas objetivo, ArrayList<Criaturas> criaturas) {
        System.out.println("\n " + this.nombre + " lanza una lluvia de flechas a " + objetivo.getNombre() + "!");
        ...
        for (Criaturas c : criaturas) {
            ...
            if (distancia <= 2) { // Solo afecta a criaturas en el radio de 1 casilla
